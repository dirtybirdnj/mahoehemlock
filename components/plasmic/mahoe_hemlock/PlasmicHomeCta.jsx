...
import TextInput from "../../TextInput"; // plasmic-import: xATQM3R6S2Gi/component
...
import sty from "./PlasmicHomeCta.module.css"; // plasmic-import: vJxynRdWnLq/css
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: moNSIPz-jqw6/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__kTjQ)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__hjt6L)}
        >
          <TextInput
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
        <div className={classNames(projectcss.all, sty.freeBox__mtFuZ)}>
          <SphereIcon
