...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: Km9rBF8KY3yJ/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__xAwBs)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__ooCwf)}>
          <div className={classNames(projectcss.all, sty.freeBox__l2Ly7)}>
            {p.renderPlasmicSlot({
