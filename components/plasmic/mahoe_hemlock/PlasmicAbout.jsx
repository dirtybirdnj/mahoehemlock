...
import sty from "./PlasmicAbout.module.css"; // plasmic-import: pC06KJurrI/css
...
const PlasmicDescendants = {
  root: ["root", "freeBox", "header", "img", "text", "footer"],
  freeBox: ["freeBox", "header", "img", "text", "footer"],
  header: ["header"],
  img: ["img"],
  text: ["text"],
  footer: ["footer"]
