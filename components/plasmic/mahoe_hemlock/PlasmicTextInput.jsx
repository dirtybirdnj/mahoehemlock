...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: xATQM3R6S2Gi/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: _5b0_PaSe2XV/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 8GbqJCSTesZ3/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__xQfXy)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__aHhMl)}
                role={"img"}
              />
            ),
